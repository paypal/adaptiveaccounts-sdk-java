...
public class Utility {
	...
	private static final String EMAIL_PARAM_KEY = "sandbox.EmailAddress";
	private static final String EMAIL_ADDRESS = "pp.devtools@gmail.com";
	...
	public static final Map<String,String> getSignatureConfig(){
		...
		configMap.put(EMAIL_PARAM_KEY, EMAIL_ADDRESS);
		return configMap;
	}
